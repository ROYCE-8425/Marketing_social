...
window.DEMO_DATA = (function() {
  ...
  const pages = [
    { id: 'demo_fb_001', name: 'SEO Trùm Demo Shop', type: 'facebook', total_conversations: 6, total_messages: 142, is_active: true },
    { id: 'demo_zl_001', name: 'SEO Trùm Zalo Care', type: 'zalo_oa', total_conversations: 4, total_messages: 87, is_active: true },
  ];
  ...
  const TEMPLATES_CUSTOMER = [
    ...
    '@SEO Trùm Care đơn hôm qua đã gửi chưa?',
  ...
  customers.forEach((c) => {
    ...
    for (let i = 0; i < msgCount; i++) {
      ...
      messages.push({
        ...
        sender_name: isCustomer ? c.name : (c.page_id === 'demo_fb_001' ? 'SEO Trùm Demo Shop' : 'SEO Trùm Zalo Care'),
        content,
